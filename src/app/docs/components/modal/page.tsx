...
import { Badge, Button, Modal, ModalHeader, ModalTitle, ModalDescription, ModalContent, ModalFooter, ModalClose } from "@/components/ui";
      ...
      >
        <div>
          ...
          <Modal open={open} onClose={() => setOpen(false)}>
            ...
            <ModalHeader>
              <ModalTitle>MODAL TITLE</ModalTitle>
              <ModalDescription>This is the modal description text.</ModalDescription>
            </ModalHeader>
            <ModalContent>
      ...
      >
        <div>
          ...
          <Modal open={open2} onClose={() => setOpen2(false)}>
            ...
            <ModalContent className="py-12 text-center">
              <p className="text-xl font-bold uppercase">SIMPLE MESSAGE</p>
              <p className="mt-2 text-gray-600">This is a simple modal with minimal content.</p>
              <Button variant="primary" className="mt-6" onClick={() => setOpen2(false)}>
                GOT IT
              </Button>
            </ModalContent>
          </Modal>
